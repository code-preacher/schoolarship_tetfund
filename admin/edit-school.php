     ...
     if (isset($_POST['sub'])) {
        $crud->updateSchool($_POST);
        }

    $tb=$crud->displayById('school',$_GET['id']);
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit School</a></li>
                                    ...
                                    <div class="basic-form">
                                      ...
                                      <form action="edit-school.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                <p class="text-muted m-b-15 f-s-12">School Name :</p>
                                                <input type="text" class="form-control input-rounded" name="name" value="<?php  echo $tb['name'];?>" placeholder="Please enter School name" required="required">
